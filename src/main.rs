...
fn main() {
    ...
    let left_idx = rng.gen_range(0..LEFT.len() - 1);

    let right_idx = rng.gen_range(0..RIGHT.len() - 1);

    println!("{}_{}", LEFT[left_idx], RIGHT[right_idx]);
}

const LEFT: [&'static str; 108] = [
    "admiring",
    "adoring",
    "affectionate",
    "agitated",
